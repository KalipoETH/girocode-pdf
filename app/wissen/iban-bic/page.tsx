        ...
        <header className="mb-6 space-y-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-50 md:text-3xl">
              IBAN &amp; BIC – Alles für den GiroCode erklärt
            </h1>
            <p className="max-w-2xl text-sm text-slate-400 md:text-base">
              Für einen gültigen GiroCode sind vor allem IBAN und – in manchen Fällen – der BIC
              relevant. Hier erfährst du, wie IBAN und BIC aufgebaut sind, wie die Prüfziffer
              berechnet wird und was du beim GiroCode beachten musst.
            </p>
          </div>
        </header>
...
{`function validateIban(iban: string): boolean {
  ...
  return BigInt(numeric) % 97n === 1n;
          ...
          <section aria-labelledby="software" className="mt-10">
            <h2 id="software">Buchhaltungssoftware mit IBAN-Verwaltung</h2>
            <p>
              Wer regelmäßig Rechnungen mit GiroCode erstellt, profitiert von einer
              Buchhaltungssoftware, die IBAN-Verwaltung, automatische GiroCode-Generierung und
              Zahlungseingangs-Matching in einem System vereint:
            </p>
            ...
            <div className="not-prose my-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-3 text-sm text-slate-300">
                  sevDesk speichert Kunden-IBANs zentral und generiert beim Erstellen einer Rechnung
                  automatisch den passenden GiroCode. Zahlungseingänge lassen sich per IBAN-Matching
                  automatisch den offenen Rechnungen zuordnen – spart Zeit und reduziert Fehler.
                </p>
                <a
              ...
              <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-3 text-sm text-slate-300">
                  FastBill bietet einfache Kontoverwaltung und automatischen GiroCode-Druck auf
                  jeder Ausgangsrechnung. Die Benutzeroberfläche ist bewusst schlank gehalten –
                  ideal für Freelancer, die schnell Rechnungen stellen wollen.
                </p>
                <a
