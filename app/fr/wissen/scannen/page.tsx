    ...
    <main className="min-h-screen bg-[#0b0c10] text-slate-100">
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
        ...
        <header className="mb-8 space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-400 md:text-base">
              Scanner un GiroCode pour effectuer un paiement ne prend que quelques secondes. Ce
              guide détaillé vous explique exactement comment procéder sur iPhone (iOS) et Android,
              avec des conseils de dépannage pour les situations difficiles.
            </p>
          </div>
        </header>
        ...
        <article className="prose prose-invert prose-slate max-w-none prose-headings:text-slate-50 prose-p:text-slate-300">
          ...
          <section aria-labelledby="solutions-pro-fr" className="mt-10">
            <h2 id="solutions-pro-fr">Solutions professionnelles pour GiroCodes en masse</h2>
            <p>
              Si vous êtes du côté émetteur et que vous souhaitez créer des GiroCodes en volume
              (nombreuses factures par mois), les logiciels de facturation professionnels sont
              indispensables :
            </p>
            ...
            <div className="not-prose mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-5">
                ...
                <p className="mb-4 text-sm text-slate-400">
                  sevDesk génère automatiquement des GiroCodes sur toutes vos factures. Chaque
                  client qui reçoit votre facture peut la scanner et payer en quelques secondes.
                  Le logiciel suit ensuite les paiements entrants et les réconcilie avec les
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-5">
                ...
                <p className="mb-4 text-sm text-slate-400">
                  FastBill simplifie la création de factures avec GiroCode intégré. Son interface
                  intuitive permet de créer des factures professionnelles en minutes, avec
                  génération automatique du GiroCode conforme à la norme EPC.
                </p>
                <a
          ...
          {/* ── Liens internes ── */}
          <section aria-labelledby="voir-aussi-scannen-fr" className="mt-10">
            <h2 id="voir-aussi-scannen-fr">Voir aussi</h2>
            <ul>
              <li>
                <Link href="/fr/wissen/banking-apps" className="text-sky-400 hover:text-sky-300">
              ...
              <li>
                <Link href="/fr/wissen/epc-standard" className="text-sky-400 hover:text-sky-300">
                  Norme EPC &amp; SEPA-QR – Structure technique
                </Link>
              </li>
            </ul>
          </section>
