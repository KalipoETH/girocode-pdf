    ...
    <main className="min-h-screen bg-[#0b0c10] text-slate-100">
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
        ...
        <header className="mb-8 space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-400 md:text-base">
              Ajouter un GiroCode à vos factures est l&apos;une des meilleures façons d&apos;accélérer
              les paiements et de réduire les erreurs. Ce guide couvre tout : les mentions légales
              obligatoires, le placement optimal du code QR et les outils pour l&apos;automatiser.
            </p>
          </div>
        </header>
        ...
        <article className="prose prose-invert prose-slate max-w-none prose-headings:text-slate-50 prose-p:text-slate-300">
          ...
          <section aria-labelledby="outils-facture-fr" className="mt-10">
            <h2 id="outils-facture-fr">Logiciels de facturation avec GiroCode intégré</h2>

            <div className="not-prose mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-5">
                <h3 className="mb-2 text-base font-semibold text-slate-50">sevDesk</h3>
                <p className="mb-4 text-sm text-slate-400">
                  Logiciel de comptabilité complet pour freelances et PME. Génération automatique
                  de GiroCodes sur les factures, suivi des paiements, rappels automatiques et
                  intégration bancaire. Idéal pour les professionnels qui émettent régulièrement
                  des factures.
                </p>
                <a
                  href="https://www.awin1.com/cread.php?awinmid=15944&awinaffid=2793610"
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-5">
                ...
                <p className="mb-4 text-sm text-slate-400">
                  Solution de facturation simple et rapide pour les indépendants. Interface
                  intuitive, GiroCode automatique sur les PDFs, gestion des dépenses et reporting
                  intégré. Parfait pour commencer rapidement sans complexité inutile.
                </p>
                <a
                  href="https://www.awin1.com/cread.php?awinmid=20766&awinaffid=2793610"
                  target="_blank"
          ...
          {/* ── Liens internes ── */}
          <section aria-labelledby="voir-aussi-facture-fr" className="mt-10">
            <h2 id="voir-aussi-facture-fr">Voir aussi</h2>
            <ul>
              <li>
              ...
              <li>
                <Link href="/fr/wissen/banking-apps" className="text-sky-400 hover:text-sky-300">
                  Applications bancaires compatibles GiroCode
                </Link>
              </li>
              <li>
