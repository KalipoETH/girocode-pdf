        ...
        <header className="mb-8 space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-400 md:text-base">
              L&apos;IBAN est l&apos;élément central de tout GiroCode. Ce guide explique sa
              structure, son fonctionnement, la validation par l&apos;algorithme Mod-97 et le rôle
              du BIC dans les paiements SEPA modernes.
            </p>
          </div>
        </header>
...
console.log(validateIBAN('XX00 0000 0000 0000 0000 000'));       // false (pays inexistant)`}
          ...
          <section aria-labelledby="logiciels-iban-fr" className="mt-10">
            <h2 id="logiciels-iban-fr">Logiciels de comptabilité avec gestion IBAN</h2>
            <p>
              Pour les professionnels qui gèrent de nombreux comptes fournisseurs et clients, un
              logiciel de comptabilité avec validation IBAN intégrée est indispensable :
            </p>
            ...
            <div className="not-prose mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-5">
                ...
                <p className="mb-4 text-sm text-slate-400">
                  sevDesk valide automatiquement les IBAN saisis dans le carnet d&apos;adresses et
                  sur les factures. Le logiciel détecte les erreurs de saisie avant qu&apos;elles ne
                  causent des problèmes et génère automatiquement les GiroCodes pour les factures.
                </p>
                <a
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-900/60 p-5">
                ...
                <p className="mb-4 text-sm text-slate-400">
                  FastBill gère les coordonnées bancaires de vos clients avec validation IBAN
                  intégrée. Créez des factures avec GiroCode automatique et suivez les paiements
                  entrants en associant les virements reçus aux factures correspondantes.
                </p>
                <a
          ...
          {/* ── Liens internes ── */}
          <section aria-labelledby="voir-aussi-iban-fr" className="mt-10">
            <h2 id="voir-aussi-iban-fr">Voir aussi</h2>
            <ul>
              <li>
