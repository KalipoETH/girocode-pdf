        ...
        <header className="mb-8 space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-400 md:text-base">
              ...
              necesarios para una transferencia bancaria y elimina la necesidad de introducir el
              IBAN, el importe y el concepto de forma manual. En esta guía te explicamos todo lo
              que necesitas saber: qué es, cómo funciona, quién puede usarlo y por qué es la
              solución de pago más inteligente para autónomos y empresas en Europa.
            </p>
          </div>
        </header>

        <article className="prose prose-invert prose-slate max-w-none prose-headings:text-slate-50 prose-p:text-slate-300 prose-li:text-slate-300 prose-strong:text-slate-200 prose-code:text-emerald-400 prose-table:text-slate-300">
          ...
          <section aria-labelledby="herramientas-profesionales" className="mt-10">
            <h2 id="herramientas-profesionales">Herramientas profesionales para usuarios de GiroCode</h2>
            <p>
              Si emites facturas con regularidad y quieres automatizar la generación de GiroCodes,
              existen soluciones de software de contabilidad y facturación que lo hacen de forma
              automática. A continuación te recomendamos dos herramientas que integran GiroCodes
              en sus facturas y están especialmente diseñadas para autónomos y pequeñas empresas
              de habla alemana:
            </p>
            ...
            <div className="not-prose mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-4 text-sm text-slate-300">
                  sevDesk es un software de contabilidad en la nube especialmente diseñado para
                  autónomos y pequeñas empresas. Genera facturas profesionales con GiroCode
                  integrado de forma automática, gestiona clientes y proveedores, y se conecta
                  con tu banco. Ideal para quien quiere automatizar toda la cadena de facturación
                  y cobro.
                </p>
                <a
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-4 text-sm text-slate-300">
                  FastBill es una solución de facturación rápida e intuitiva para freelances y
                  autónomos. Crea facturas con GiroCode incluido en pocos clics, hace seguimiento
                  de los pagos y automatiza los recordatorios. Una opción excelente para quien
                  busca simplicidad sin renunciar a funcionalidades profesionales.
                </p>
                <a
            ...
            <p className="mt-4">
              Si prefieres una solución gratuita, completamente local y respetuosa con la
              privacidad, nuestro <Link href="/es" className="text-sky-400 underline underline-offset-2 hover:text-sky-300">Generador de GiroCode</Link> es
              la opción ideal. Genera el código directamente en tu navegador, sin enviar datos
              a ningún servidor.
            </p>
          </section>

          <section aria-labelledby="enlaces-internos" className="mt-10">
            <h2 id="enlaces-internos">Continúa aprendiendo</h2>
            <p>
              ¿Quieres saber más sobre los fundamentos técnicos y el uso práctico del GiroCode?
              Te recomendamos estos artículos de nuestra sección de información:
            </p>
            <ul>
              <li>
