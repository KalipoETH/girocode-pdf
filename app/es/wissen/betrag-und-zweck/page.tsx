    ...
    <main className="min-h-screen bg-[#0b0c10] text-slate-100">
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
        ...
        <header className="mb-8 space-y-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-50 md:text-3xl">
              Importe y concepto de pago en GiroCode – Guía completa
            </h1>
            <p className="mt-2 max-w-2xl text-sm text-slate-400 md:text-base">
              El importe y el concepto de pago son los dos campos variables más importantes de
              un GiroCode. Cómo los configures determina si la conciliación de pagos será
              sencilla o un dolor de cabeza. En esta guía encontrarás el formato exacto,
              los límites técnicos, las mejores prácticas para cada sector y ejemplos concretos.
            </p>
          </div>
        </header>
        ...
        <article className="prose prose-invert prose-slate max-w-none prose-headings:text-slate-50 prose-p:text-slate-300 prose-li:text-slate-300 prose-strong:text-slate-200 prose-code:text-emerald-400 prose-pre:bg-slate-900 prose-pre:border prose-pre:border-slate-700">
          ...
          <section aria-labelledby="facturacion-conceptos" className="mt-10">
            <h2 id="facturacion-conceptos">Facturación profesional con conceptos correctos</h2>
            <p>
              Si emites muchas facturas y quieres automatizar tanto la generación del concepto
              como la del GiroCode, un software de facturación profesional puede hacer este
              trabajo por ti de forma sistemática y sin errores:
            </p>
            ...
            <div className="not-prose mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-4 text-sm text-slate-300">
                  FastBill genera automáticamente el concepto de pago correcto a partir del
                  número de factura y los datos del cliente. Incluye el GiroCode en cada
                  factura PDF con el importe y concepto correctos, y hace seguimiento de los
                  pagos pendientes. Ideal para autónomos con muchas facturas mensuales.
                </p>
                <a
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-4 text-sm text-slate-300">
                  sevDesk integra la generación de GiroCodes directamente en su flujo de
                  facturación. El concepto se genera automáticamente con el número de factura
                  y otros identificadores configurables, garantizando que cada pago llegue
                  correctamente identificado. Perfecto para pymes que necesitan contabilidad
                  completa además de facturación.
                </p>
                <a
            ...
            <p className="mt-4">
              Para proyectos puntuales o si prefieres una solución gratuita, nuestro{' '}
              <Link href="/es" className="text-sky-400 underline underline-offset-2 hover:text-sky-300">
                Generador de GiroCode gratuito
              </Link>{' '}
              te permite configurar manualmente el importe y el concepto de forma sencilla,
              con validación integrada para evitar errores de formato.
            </p>
          </section>

          <section aria-labelledby="mas-articulos-betrag" className="mt-10">
            <h2 id="mas-articulos-betrag">Artículos relacionados</h2>
            <ul>
              <li>
