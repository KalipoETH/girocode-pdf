        ...
        <header className="mb-8 space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-400 md:text-base">
              El IBAN es el elemento central de cualquier GiroCode. En esta guía completa
              explicamos su estructura, cómo se valida, cuándo sigue siendo necesario el BIC,
              y todo lo que necesitas saber sobre estos identificadores bancarios en el
              contexto de los pagos SEPA.
            </p>
          </div>
        </header>
...
console.log(validateIBAN('DE89370400440532013001')); // false`}
          ...
          <section aria-labelledby="software-iban" className="mt-10">
            <h2 id="software-iban">Software de contabilidad con gestión de IBAN</h2>
            <p>
              Si gestionas múltiples cuentas bancarias o necesitas validar y almacenar IBANs
              de clientes y proveedores de forma sistemática, un software de contabilidad
              profesional puede simplificar enormemente este trabajo:
            </p>
            ...
            <div className="not-prose mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-4 text-sm text-slate-300">
                  sevDesk almacena y valida los IBANs de tus clientes y proveedores
                  automáticamente. Al crear una factura con GiroCode, los datos bancarios
                  se rellenan desde tu base de datos de contactos, eliminando errores de
                  copia y pegado. El software también genera el GiroCode correcto con el
                  IBAN validado.
                </p>
                <a
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-5">
                ...
                <p className="mb-4 text-sm text-slate-300">
                  FastBill simplifica la gestión de datos bancarios de clientes y la creación
                  de facturas con GiroCode integrado. Especialmente útil para autónomos que
                  trabajan con clientes recurrentes y necesitan que los datos del IBAN estén
                  siempre correctos y actualizados en sus facturas.
                </p>
                <a
          ...
          <section aria-labelledby="mas-articulos-iban" className="mt-10">
            <h2 id="mas-articulos-iban">Artículos relacionados</h2>
            <ul>
              <li>
