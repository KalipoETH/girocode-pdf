        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="not-prose mt-10 flex flex-col gap-8 border-t border-slate-800 pt-8">
            ...
            <div>
              <Link
                href={t.ctaHref}
                className="inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold text-slate-950 shadow-lg transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(34,197,94,0.25)]"
